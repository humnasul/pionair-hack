...
def main():
    ...
    # Environmental measurements - real PM2.5 / O3 / NO2 columns, not the
    # composite AQI figure, so the model has a matching feature for each
    # pollutant the app now fetches individually from OpenWeatherMap.
